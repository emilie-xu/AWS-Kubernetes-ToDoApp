from flask import Flask, render_template,request,redirect,url_for, abort # For flask implementation
...
def tasks ():
	...
	a2="active"
	return render_template('index.html',a2=a2,todos=todos_l,t=title,h=heading), 200
